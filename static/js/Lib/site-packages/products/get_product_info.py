...
class GetProductInfoResponse:
    def __init__(self,product_code=None, loaded=False, message=None) -> None:
...
class GetProductInfo:
    def __init__(self,product_code) -> None:
        ...
        self.cable="/modules/api_cable/get_product_info.php"
        self.product_code=product_code
        self.image_element=None
        self.product_label_element=None
        self.product_description_element=None
        self.__onload=None
    def on_load(self,cb):
        self.__onload=cb
