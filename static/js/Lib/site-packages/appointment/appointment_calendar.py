...
class AppointmentCalendar:
    ...
    def add_appointment_modal_show(self,month,day,year,from_time,to_time,branch='Please choose a branch'):
        ...
        selected_appointment="{year}-{month}-{day}".format(year=year,month=month,day=day)
        self.add_appointment=AddAppointment(branch=self.branch,appointment_date=selected_appointment)
